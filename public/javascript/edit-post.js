...
function updatePost(title, post_content, id) {
    ...
    // document.getElementById('input[name="update-post-title"]').value = "test"
    // document.querySelector('#update-post-title').value = "test"
...
// document.querySelector("#update-post-btn-1").addEventListener("click", updatePost)


if (document.querySelector(".update-post-btn-1")) {
    document.querySelector(".update-post-btn-1").addEventListener("submit", editFormHandler);
}