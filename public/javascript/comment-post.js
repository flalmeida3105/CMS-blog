async function commentPost(postId) {
    ...
    console.log("title: ", title, post_content, comments);
        ...
        commentContent = `
            <div class="flex flex-col  justify-center p-10" id="dashboard-content">
                <div class=" w-full h-full md:h-auto p-6 bg-gray-200 rounded-lg border border-gray-400 shadow-md sm:p-6 lg:p-8">
                    ...
                    <div class="m-10 max-w-full border border-gray-600">
                        <div class="max-w-full p-4 bg-gray-400 border border-gray-400 shadow-lg text-2xl flex justify-between items-center">Submit a new comment</div>
                        <p class="m-4">
                        ...
                        <button type="button" onClick="submitCommentFormHandler(${postId}, ${user_id})"
                            class="update-post-btn-1 mt-8 text-black bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full  px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit
                            Comment</button>
                        </p>
                    </div>
                </div>
